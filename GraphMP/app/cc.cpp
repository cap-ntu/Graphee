...
int main(int argc, char *argv[]) {
  ...
  // pg.init("/data/5/GraphData/eu/edge/", 1070560000, 5096,  500);
  // pg.init("/data/5/GraphData/twitter/edge2/", 41652250, 294,  150);
  // pg.init("/data/5/GraphData/uk/edge3/", 787803000, 2379,  500);
